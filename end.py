...
# FLAGS.init_checkpoint_start = 'output_start_6/model.ckpt-376'
...
#       start_loss = compute_loss(start_logits, start_positions)
      ...
      logging_hook = tf.train.LoggingTensorHook({"Step": tf.train.get_global_step(), "Total loss" : total_loss}, every_n_iter=10)
...
def main(_):
  ...
  if FLAGS.do_train:
    train_examples = ps.read_squad_examples(
